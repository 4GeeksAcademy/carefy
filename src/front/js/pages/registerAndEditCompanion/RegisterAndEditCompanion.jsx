...
const RegisterAndEditCompanion = () => {
  ...
  title={store.editCompanionOrNewCompanion ? "Completa tu perfil así te encuentran" : "Editar"}
  subtitle={store.editCompanionOrNewCompanion ? "En tan solo unos minutos tendrás listo tu perfil para empezar a trabajar" : "Aquí puedes modificar tus datos"}
/>
