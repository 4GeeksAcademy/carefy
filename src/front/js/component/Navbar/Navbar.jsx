    ...
    return (
        <nav className="navbar navbar-expand-lg nabvar-bg">
            <div className="container-fluid">
                <a className="navbar-brand text-light fs-4" href="#">Carefy</a>
                <div className="navbar-left">
                    ...
                    <div className="collapse navbar-collapse fs-4" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <a className="nav-link text-light" aria-current="page" href="#">Nosotros</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link text-light" aria-current="page" href="#">FAQ</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link text-light" aria-current="page" href="#">Blog</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link text-light" aria-current="page" href="#">Contacto</a>
                            </li>
                        </ul>
